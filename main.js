...
//сейчас не работает эта сраная туманность на главном лого. если добавить анимацию с помощью tween
//то нужно соблюсти условие что разрешение больше 540px, и в конструкции if она не возвращается
//в исходное положение. еще не работает toggleClass и класс меняется на kaspersky2 откуда возникают
//проблемы с появлением слайдера из фейда.